  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: "bg-card/80 backdrop-blur-xl border border-border/50 hover:bg-card/90 text-foreground shadow-sm",
        success: "bg-success text-success-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        warning: "bg-warning text-warning-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        danger: "bg-destructive text-destructive-foreground shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        alarm: "bg-destructive text-destructive-foreground shadow-lg animate-pulse hover:scale-[1.02]",
      },
      size: {
